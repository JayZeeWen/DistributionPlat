...
namespace ComHelper
{
    ...
    {
        public static bool DealRewardScore(DistributionContext context, int AgentId, RewartType reType)
        {
            bool result = true;
        ...
        public static bool DealProvinceReward(Agent BeRecommAgent,DistributionContext context)
        {
            bool result = true;
            int ProReward = 100;
        ...
        public static void UpdateAgentScore(int AgentId, int ChangeScore,DistributionContext context,string reason = "操作变更")
        {
        ...
        //(递归)找到代理商的所有上级中的最高级别
        public static int GetMaxLevel(int AgentId,DistributionContext context )
        {
            int max_Level = 1;
            int parLevel = 0;
